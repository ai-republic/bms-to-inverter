...
/**
 * The {@link BMSDescriptor} for the ZTE BMS using the Modbus protocol.
 */
public class ZTEBmsModbusDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return ZTEBmsModbusProcessor.class;
    }
