...
/**
 * The {@link BMSDescriptor} for the Samsung BMS using the CAN protocol.
 */
public class SamsungBmsCANDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return SamsungBmsCANProcessor.class;
    }
