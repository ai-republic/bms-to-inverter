...
/**
 * The {@link BMSDescriptor} for the Shoto BMS using the Modbus protocol.
 */
public class ShotoBmsModbusDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return ShotoBmsModbusProcessor.class;
    }
