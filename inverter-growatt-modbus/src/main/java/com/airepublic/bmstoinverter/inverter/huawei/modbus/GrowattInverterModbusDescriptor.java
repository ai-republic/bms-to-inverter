...
/**
 * The {@link InverterDescriptor} for the Growatt inverter using the Modbus protocol.
 */
public class GrowattInverterModbusDescriptor implements InverterDescriptor {
    @Override
    ...
    public Class<? extends Inverter> getInverterClass() {
        return GrowattInverterModbusProcessor.class;
    }
