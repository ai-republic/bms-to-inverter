...
/**
 * The {@link InverterDescriptor} for the Luxpower {@link Inverter} using the CAN protocol.
 */
public class LuxpowerInverterCANDescriptor implements InverterDescriptor {
    @Override
    ...
    public Class<? extends Inverter> getInverterClass() {
        return LuxpowerInverterCANProcessor.class;
    }
