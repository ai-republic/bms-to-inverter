...
/**
 * The {@link BMSDescriptor} for the Luxpower BMS using the CAN protocol.
 */
public class LuxpowerBmsCANDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return LuxpowerBmsCANProcessor.class;
    }
