 ...
 */
package com.airepublic.bmstoinverter.inverter.byd.can;
...
/**
 * The {@link InverterDescriptor} for the BYD HV {@link Inverter} using the CAN protocol.
 */
public class BydInverterCANDescriptor implements InverterDescriptor {
    @Override
    ...
    public Class<? extends Inverter> getInverterClass() {
        return BydInverterCANProcessor.class;
    }
