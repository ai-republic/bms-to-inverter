...
/**
 * The {@link BMSDescriptor} for the Megarevo LV BMS using the CAN protocol.
 */
public class MegarevoBmsCANDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return MegarevoBmsCANProcessor.class;
    }
