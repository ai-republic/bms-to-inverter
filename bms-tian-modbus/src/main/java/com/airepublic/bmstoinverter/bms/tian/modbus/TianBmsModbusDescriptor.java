...
/**
 * The {@link BMSDescriptor} for the Tian BMS using the Modbus protocol.
 */
public class TianBmsModbusDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return TianBmsModbusProcessor.class;
    }
