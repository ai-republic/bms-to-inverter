...
/**
 * The {@link BMSDescriptor} for the Growatt {@link BMS} using the CAN protocol.
 */
public class GrowattBmsCANDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return GrowattBmsCANProcessor.class;
    }
