...
/**
 * The {@link BMSDescriptor} for the Huawei BMS using the Modbus protocol.
 */
public class HuaweiBmsModbusDescriptor implements BMSDescriptor {
    @Override
    ...
    public Class<? extends BMS> getBMSClass() {
        return HuaweiBmsModbusProcessor.class;
    }
