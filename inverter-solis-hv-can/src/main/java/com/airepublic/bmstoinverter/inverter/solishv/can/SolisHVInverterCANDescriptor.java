...
/**
 * The {@link InverterDescriptor} for the Solis HV {@link Inverter} using the CAN protocol.
 */
public class SolisHVInverterCANDescriptor implements InverterDescriptor {
    @Override
    ...
    public Class<? extends Inverter> getInverterClass() {
        return SolisHVInverterCANProcessor.class;
    }
