...
public enum JBDRS485DataId {
     ...
     */
    JBDRS485DataId(final byte dataId, final int length) {
        this.dataId = dataId;
        this.length = length;
    }
    ...
    /**
     * Gets the {@link JBDRS485DataId} for the specified data id.
     *
     * @param dataId the byte resembling a valid data id
     * @return the {@link JBDRS485DataId}
     */
    public static JBDRS485DataId fromDataId(final byte dataId) {

        for (final JBDRS485DataId value : values()) {
