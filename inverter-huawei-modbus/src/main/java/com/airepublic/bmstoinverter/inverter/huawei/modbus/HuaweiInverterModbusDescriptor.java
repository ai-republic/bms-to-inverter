...
/**
 * The {@link InverterDescriptor} for the Huawei inverter using the Modbus protocol.
 */
public class HuaweiInverterModbusDescriptor implements InverterDescriptor {
    @Override
    public String getName() {
        return "HUAWEI_MODBUS";
    }
    ...
    public Class<? extends Inverter> getInverterClass() {
        return HuaweiInverterModbusProcessor.class;
    }
