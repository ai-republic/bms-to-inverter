 ...
 */
public class DiscoverBmsCANDescriptorTest {
    private static final DiscoverBmsCANDescriptor desc = new DiscoverBmsCANDescriptor();

    @Test
    public void testName() {
        Assertions.assertEquals("DISCOVER_CAN", desc.getName());
    }


    @Test
    public void testBMSClass() {
        Assertions.assertEquals(DiscoverBmsCANProcessor.class, desc.getBMSClass());
    }
